...
def converse():
    ...
    if model_name=='Meta-Llama-3-8B-Instruct':
        model_path=r"D:\Meta-Llama-3-8B-Instruct"
        print('I am using meta-llama3 model')
    elif model_name=='Mistral-7B-Instruct-v0.2':
        model_path=r"D:\StableGPT\models\Mistral-7B-Instruct-v0.2"
        print('I am using Mixtral 7b model')
